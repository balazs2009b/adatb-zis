...
| 03 Táblák kezelése | `koltok.db` (evek 10 + masolat 10) | `parancsok.sqlite-query` | UPDATE, DELETE, tábla másolása, ALTER TABLE, parancs–leírás párosítás |
...
| 08 Színészek | `szineszek.db` (145 sor) | `megoldas.sqlite-query` | 5 lekérdezés + Grace Kelly segédlekérdezés |
| 09 Repterek | `repterek.db` (palyak, 63 sor) | `megoldas.sqlite-query` | INSERT, GROUP BY/HAVING, terület-segédlekérdezés, NOT IN |
| 10 Országok | `orszagok.db` (adatok, 88 sor) | `megoldas.sqlite-query` | length, LIKE, count/sum, két segédlekérdezés |
